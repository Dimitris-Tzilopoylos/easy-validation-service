...
declare class ValidationService {
    ...
    static validateBodyWithErrors(data: any, validators: any, parentData: any): false | {
        isValid: any;
        errors: {};
    };
    ...
    static validateMW(validatorsConfig: any): (req: any, res: any, next: any) => Promise<void>;
